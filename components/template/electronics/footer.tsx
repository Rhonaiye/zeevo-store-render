...
import { Mail, Phone, MapPin, Instagram, Facebook, Twitter, Zap, Award } from 'lucide-react';
import { BsTiktok } from 'react-icons/bs';

function ElectronicsFooter({ store }: { store: Store }) {
  const { name, logo, secondaryColor = '#0066cc', primaryColor, contact, socialLinks, policies } = store;
  ...
  return (
    <footer
      ...
      style={{ backgroundColor: secondaryColor || '#0066cc' }}
    >
            ...
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm opacity-90 flex items-center gap-1">
                  <Zap size={14} /> Premium Tech Store
                </p>
              </div>
            </div>
            <p className="text-sm leading-relaxed opacity-90">
              Your trusted destination for the latest electronics and gadgets. Premium quality, competitive prices, and expert support.
            </p>
          </div>
